            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  child: Text(name.isNotEmpty ? name[0] : '?', style: const TextStyle(color: MyColors.textPrimary)),
                ),
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              name,
                              style: const TextStyle(fontWeight: FontWeight.w700, color: MyColors.textPrimary),
                            ),
                          ),
                          Text(
                            time,
                            style: const TextStyle(color: MyColors.textSecondary, fontSize: 12),
                          ),
                        ],
                      ),
