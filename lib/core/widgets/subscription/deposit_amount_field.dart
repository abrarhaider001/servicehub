...
class DepositAmountField extends StatelessWidget {
  final TextEditingController controller;
  final void Function(double amount)? onChanged;
  const DepositAmountField({super.key, required this.controller, this.onChanged});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text('Deposit amount', style: TextStyle(fontWeight: FontWeight.w700, color: MyColors.textPrimary)),
